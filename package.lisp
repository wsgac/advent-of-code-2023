...
(defpackage #:advent-of-code-2023.day14
  (:nicknames #:aoc2023.day14)
  (:use #:cl #:util))

(defpackage #:advent-of-code-2023.day15
  (:nicknames #:aoc2023.day15)
  (:use #:cl #:util))
...
(defpackage #:advent-of-code-2023.day19
  (:nicknames #:aoc2023.day19)
  (:use #:cl #:util))
