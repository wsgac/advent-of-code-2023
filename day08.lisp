(in-package #:advent-of-code-2023.day08)

(defun string-to-directions (string)
  (loop
    for c across string
    collect (alexandria:make-keyword c)))

(defun parse-data (data)
  (destructuring-bind (directions map)
      (ppcre:split "\\n\\n" data)
    (let ((parsed (list :directions (apply #'alexandria:circular-list
